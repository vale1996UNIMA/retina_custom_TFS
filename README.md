...
python keras_retinanet/bin/train.py --weights resnet50_csv_23_modelo_funcional_previo.h5 --steps 20 --epochs 30 --snapshot-path snapshots --tensorboard-dir tensorboard csv dataset/train.csv dataset/clas
ses.csv --val-annotations dataset/test.csv

python keras_retinanet/bin/convert_model.py D:\UNIMA\Retina_FUNCIONAL\snapshots\resnet50_csv_01.h5 D:\UNIMA\Retina_FUNCIONAL\snapshots\inference\new_card_v2.h5

python h5_to_pb.py --input_model  "D:\UNIMA\Retina_FUNCIONAL\snapshots\inference\new_card_v2.h5" --output_model "D:\UNIMA\Retina_FUNCIONAL\snapshots\freeze_model\new_card_v2.pb"
